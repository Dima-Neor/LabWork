...
void filling2(char *array[])
{
    ...
    if (menu == 1)
    {
        ...
        cin >> array[0];
        words << array[0];
        for (size_t i = 0; !words.eof() && i < 100; i++)
        {
            words.getline(array[i], ';');
        }
    }
    else
    {
...
int tasck2 (vector <string> array)
{
    ...
    {
        if (array[i].at(array[i].size() - 1) == c) counter++;
    }
    return counter;
}
    ...
    do
    {
        ...
        case 2:
            ...
            case 2:
                ...
                cout << "Количество слов окачивающихся на данную букву: " << cout << "\n";
                break;
